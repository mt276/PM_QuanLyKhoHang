...
namespace BUS.BUS
{
    public class TypeReferrerBUS
    {
        private static TypeReferrerDAO handle = new TypeReferrerDAO();

        #region "[Insert]"
        public static int Insert(TypeReferrerDTO _obj)
        {
            int iResult = -1;
            try
            {
        ...
        public static TypeReferrerDTO SelectPrimaryKey(int _iID)
        {
        ...
        #region "[Update]"
        public static bool Update(TypeReferrerDTO _obj)
        {
            bool isResult = false;
            try
            {
        ...
        #region "[GetAll]"
        public static List<TypeReferrerDTO> GetAll()
        {
